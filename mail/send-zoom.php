...
$subjek = 'Zoom Class Link'; // Ambil subjek dari inputan form
$pesan1 = $_POST['link_zoom'];
$pesan2 = $_POST['pass_zoom']; // Ambil pesan dari inputan form
