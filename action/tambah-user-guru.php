 ...
 if($tipe_file == "image/jpeg" || $tipe_file == "image/png"){ // Cek apakah tipe file yang diupload adalah JPG / JPEG / PNG
    ...
    if($ukuran_file <= 104857600){ // Cek apakah ukuran file yang diupload kurang dari sama dengan 1MB
        ...
        if(move_uploaded_file($tmp_file, $path)){ // Cek apakah gambar berhasil diupload atau tidak
            ...
            $query = "INSERT INTO pengguna(nama,ukuran,tipe,nama2,telp,email,hak_akses,username,password,asal,pendidikan_terakhir,pengalaman_mengajar) VALUES('$random".$nama_file."','".$ukuran_file."','".$tipe_file."','".$nama2."','".$telp."','".$email."','".$hak_akses."','".$username."','".$password."','".$asal."','".$pendidikan_terakhir."','".$pengalaman_mengajar."') ";
            ...
            if($sql){ // Cek jika proses simpan ke database sukses atau tidak
				...
				echo "  </tr>";
				echo "  <tr>";
				echo "	<td  >   <a href='../users/Manager/guru.php'><button type='button' class='accordiona' width='40%'>Back </button></a><br /><br />";
				echo "</td>";
				echo "  </tr>";
				echo "</table>";
            ...
            // Jika gambar gagal diupload, Lakukan :
                ...
                echo "  </tr>";
                echo "  <tr>";
                echo "  <td  > <a href='../users/Manager/guru.php'><button type='button' class='accordiona' width='40%'>Back </button></a><br /> ";
                echo "</td>";
                echo "  </tr>";
                echo "</table>";
        }
