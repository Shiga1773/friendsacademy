         ...
         <!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-file"></i> Class List
                            </li>
                         </ol>
                         </div>
                </div>
   ...
   <form action="" method="post" enctype="multipart/form-data" target="_blank">
                  <div class="col-lg-8">
                       ...
                       <div class="table-responsive">
                        ...
                        $query = "SELECT * FROM `jadwal_kelas`where jenis_kelas='s' and id_guru='$id_guru' SORT BY tanggal ASC"; // Tampilkan semua data gambar
    ...
    <form action="" method="post" enctype="multipart/form-data" target="_blank">
                  <div class="col-lg-8">
                       ...
                       <div class="table-responsive">
                        ...
                        $query = "SELECT * FROM `jadwal_kelas`where jenis_kelas='m' and id_guru='$id_guru'"; // Tampilkan semua data gambar
                        $sql = mysqli_query($connect, $query); // Eksekusi/Jalankan query dari variabel $query
                        $row = mysqli_num_rows($sql); // Ambil jumlah data dari hasil eksekusi $sql
 ...
 <form action="" method="post" enctype="multipart/form-data" target="_blank">
                  <div class="col-lg-8">
                       ...
                       <div class="table-responsive">
                        ...
                        $query = "SELECT * FROM `jadwal_kelas`where jenis_kelas='xl' and id_guru='$id_guru'"; // Tampilkan semua data gambar
                        $sql = mysqli_query($connect, $query); // Eksekusi/Jalankan query dari variabel $query
                        $row = mysqli_num_rows($sql); // Ambil jumlah data dari hasil eksekusi $sql
