         ...
         <!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-file"></i> Find User
                            </li>
                         </ol>
                         </div>
                </div>
...
<form name="myForm" method="post" enctype="multipart/form-data" target="_blank" >
<div class="row"> 
                        ...
                        $query = "SELECT * FROM pengguna WHERE hak_akses='Guru' AND nama2 LIKE '$cari%' OR hak_akses='Guru' AND nama2 LIKE '%$cari' OR hak_akses='Guru' AND nama2 LIKE '%$cari%' "; // Tampilkan semua data gambar
...
<div class='column'>
    <div class='carda'>
     ...
     <h2>".$data['nama2']."</h2>
     <p><strong>".$data['email']."<br>".$data['telp']."</strong></p>
    
      <p>&nbsp;</p>

      <p> <button type='submit' style='width:100%;' class='btn btn-sm btn-info' name='submit' id='more_d' formaction='hapus-pengguna.php' ><label><input name='check_list2[]' type='radio' value='".$data['id']."' style='visibility:hidden'>Delete User&nbsp;&nbsp;&nbsp;</label></button></p>
