...
mysql_select_db($database_koneksi, $koneksi);
$query_list_username = "SELECT username FROM pengguna_request";
...
<body>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        Hapus Request Member</h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-file"></i> Hapus Request Tambah Member
                            </li>  
                        </ol>
                    </div>
                </div>
            ...
            <form method="post" enctype="multipart/form-data" action="hapus-request.php">
             <table class="table">
					<thead>
						<tr>
