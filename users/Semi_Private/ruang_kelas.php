...
<hr>
 ...
 <table class="table table-bordered table-hover table-striped">
                               <thead>
                        <tr>
                            <th colspan="2">Semi-Private Class Taken</th>
...
inner join jadwal_book_m on pengguna.id = jadwal_book_m.id_pengguna 
WHERE jadwal_book_m.id_pengguna='$id_user' ORDER by jadwal_book_m.tanggal asc"; // Tampilkana semua data gambar
