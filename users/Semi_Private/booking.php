...
<div class="rowa">
                        ...
                        $query = "SELECT * FROM jadwal_kelas WHERE id_guru='$selected' AND jenis_kelas='m' AND nama_kelas='semi_private' "; // Tampilkan semua data gambar
    ...
    <input type='hidden' name='id_pengguna' id='id_pengguna' value='$id_user' >
      ...
      <p> <button type='submit' class='btn btn-sm btn-info'  name='submit' id='more_d' formaction='../../action/tambah_kelas_book_m.php' style='width:100%;'><label><input name='check_list2[]'  type='radio' value='".$data['jenis_kelas']."' style='visibility:hidden'>Book&nbsp;&nbsp;</label></button></p>
    </div>
  </div>                 
