...
<form action="foto 2-action.php" method="post" enctype="multipart/form-data" target="_blank">
<input name="" type="hidden" value="<?php print "$id"; ?>" />
<table width="100%" border="0">
  <tr>
    <td width="8%" rowspan="3">Foto 2<br /><?php print "$foto2"; ?></td>
    <td >Foto Baru : <br /> <input type="file" name="foto"></td>
  </tr>
  <tr>
    <td ><input name="id2" type="hidden" value="<?php print "$id"; ?>" /><input name="file2" type="hidden" value="<?php print "$file2"; ?>" /></td>
  </tr>
  <tr>
