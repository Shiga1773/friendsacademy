...
<form action="foto 1-action.php" method="post" enctype="multipart/form-data" target="_blank">
<input name="" type="hidden" value="<?php print "$id"; ?>" />
<table width="100%" border="0">
  <tr>
    <td width="8%" rowspan="3">Foto 1<br /><?php print "$foto1"; ?></td>
    <td >Foto Baru : <br /> <input type="file" name="nama"></td>
  </tr>
  <tr>
    <td ><input name="id1" type="hidden" value="<?php print "$id"; ?>" /><input name="file" type="hidden" value="<?php print "$file"; ?>" /></td>
  </tr>
  <tr>
