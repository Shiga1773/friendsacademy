		 ...
		 <!-- Page Heading -->
				<div class="row">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							<li>
								<i class="fa fa-file"></i> Group Class, 25 Student Max
							</li>
						 </ol>
						 </div>
				</div>
...
<form action="" method="post" enctype="multipart/form-data" target="_blank">
               ...
               <td rowspan='3' width='20%'><img src='../../images/pengguna/".$data['nama']."' style='width:100%;''></td>
                          ...
                          <tr>
                            ...
                            <td width='1%'> </td>
                           <td width='30%' >
                           <button type='submit' class='btn btn-sm btn-info'  name='submit' id='more_d' formaction='booking-25.php' style='width:100%;'><label><input name='check_list2[]'  type='radio' value='".$data['id']."' style='visibility:hidden'>Book&nbsp;&nbsp;</label></button>
