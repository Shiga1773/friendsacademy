         ...
         <!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-file"></i> Group Class - <strong><?php print($nama_guru) ?></strong>
                            </li>
                         </ol>
                         </div>
                </div>
...
<div class="rowa">
                        ...
                        $query = "SELECT * FROM jadwal_kelas WHERE id_guru='$selected' AND jenis_kelas='xl' AND nama_kelas='group' "; // Tampilkan semua data gambar
    ...
    <div class='card'>
     ...
     <h4>Date</h4><h2><input style='border :none; outline: none;text-align: center;background: transparent;width:100%;' type='text' id='tanggal' name='tanggal' value='" .$data['tanggal'] ."' readonly></h2>
      <h2><input style='border :none; outline: none;text-align: center;background: transparent;width:100%;' type='text' id='jam_kelas' name='jam_kelas' value='" .$data['jam_kelas'] ."' readonly></h2>
    ...
    <input type='hidden' name='id_pengguna' id='id_pengguna' value='$id_user' >
      ...
      <p> <button type='submit' class='btn btn-sm btn-info'  name='submit' id='more_d' formaction='../../action/tambah_kelas_book_xl.php' style='width:100%;'><label><input name='check_list2[]'  type='radio' value='".$data['jenis_kelas']."' style='visibility:hidden'>Book&nbsp;&nbsp;</label></button></p>
    </div>
  </div>                 
