...
<table >
  ...
  <tr>
  <td>  </td>
  <td colspan="2"><input type="submit" name="button2" formaction="upload/ganti_foto_profile.php" id="button2" value="Change"></td>
  </tr>
  <tr>
    <td>Phone/WA</td>
  ...
  <tr>
  <td colspan="3"><input type="submit" name="button" class="btn btn-lg btn-success btn-block"   id="button"  value="Save" /></td>
  </tr>
...
function validateForm2() {
   ...
   if (a == "") {
        alert("New Username Empty");
    $("#username_log").focus();
        return false;
    }else{
  if (a == "<?php print"$username";?>") {
        alert("New Username same As Old Username");
    $("#username_log").focus();
        return false;
    }
  }
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                            <i class="fa fa-info-circle"></i>  
                            Change Username - 25 Character Max
                        </div>
                    </div>
                    </div>
                     <!-- /.dismisable alert -->
                    ...
                    <div style="overflow-x:auto;">
                      ...
                      <tr>
                        <td width="200px">New Username</td>
...
if ($result->num_rows > 0) {
    ...
    print "New Username can be Used";
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                            <i class="fa fa-info-circle"></i>  
                            Change Password - 25 Character Max
                        </div>
                    </div>
                    </div>
                     <!-- /.dismisable alert -->
                    ...
                    <table>
                        ...
                        <tr>
                        <td colspan="2"><input type="submit" name="button" class="btn btn-lg btn-success btn-block"   id="button"  value="Save" /></td>
                        </tr>
                      </table>
...
<br>
                     ...
                     <form action="upload/pengalaman.php" name="myForm" method="post" enctype="multipart/form-data">
                    ...
                    <div style="overflow-x:auto;">   
                      ...
                      <table>
                        ...
                        <tr>
                          <td width="200px">Education</td>
                          <td><input name="pendidikan" type="text" id="pendidikan" size="50" value="<?php print($pendidikan) ?>"></td>
                       
                          
                        </tr>
                        <tr>
                          <td>Teaching Experience</td>
                          <td><textarea name="pengalaman" id="pengalaman" rows="5" cols="50"><?php print($pengalaman) ?></textarea></td>
